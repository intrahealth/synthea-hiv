...
# create 100 000 patients
docker build --no-cache --build-arg POP=100000 -t intrahealth/synthea-hiv:pop100000 .
docker tag intrahealth/synthea-hiv:pop100000 intrahealth/synthea-hiv:pop100000
docker push intrahealth/synthea-hiv:pop100000

# create 1 000 000 patients
docker build --no-cache --build-arg POP=1000000 -t intrahealth/synthea-hiv:pop1000000 .
docker tag intrahealth/synthea-hiv:pop1000000 intrahealth/synthea-hiv:pop1000000
docker push intrahealth/synthea-hiv:pop1000000